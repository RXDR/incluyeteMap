...
interface RightSidebarGeneralBarriosProps {
  data: Array<{
    barrio: string;
...
const RightSidebarGeneralBarrios: React.FC<RightSidebarGeneralBarriosProps> = ({ data, headerHeight }) => {
...
export default RightSidebarGeneralBarrios;
